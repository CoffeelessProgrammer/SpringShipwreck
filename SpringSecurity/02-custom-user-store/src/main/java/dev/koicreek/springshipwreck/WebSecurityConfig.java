...
public class WebSecurityConfig {
    ...
    @Bean
    public AuthenticationProvider dbAuthProvider(UserDetailsService userDetailsSvcImpl, PasswordEncoder passwordEncoder) {
    ...
    @Bean
    public AuthenticationProvider inMemoryAuthProvider(UserDetailsService inMemoryUserDetailsService, PasswordEncoder passwordEncoder) {
        DaoAuthenticationProvider provider = new DaoAuthenticationProvider();
